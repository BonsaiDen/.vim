...
syn keyword lufaKeyword             extends implements
syn keyword lufaBlock               if elif else try catch finally raise for while scope ret yield
syn keyword lufaAsciiOperator	    new del is has in as
syn keyword lufaType		    void bool int float string list map struct class var
syn keyword lufaBoolean             true false
syn keyword lufaNull                null

syn keyword lufaModifier	    async const static abstract public protected private
syn keyword lufaModule              import export extern
